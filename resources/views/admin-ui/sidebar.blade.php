<div class="sidebar sidebar-dark sidebar-main sidebar-expand-md">
    ...
    <div class="sidebar-content">
        ...
        <!-- User menu -->
        <div class="sidebar-user-material d-xl-none">
            <div class="sidebar-user-material-body">
                <div class="card-body text-center">
                    <a href="#">
                        <img src="{{asset('admin-ui/material/main_assets/images/image.png')}}" class="img-fluid rounded-circle shadow-1 mb-3" width="80" height="80" alt="">
                    </a>
        ...
        <div class="card card-sidebar-mobile">
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                <li class="nav-item">
                    <a href="{{route('home.dashboard')}}" class="nav-link {{request()->is('/')? 'active':''}}">
                        <i class="icon-home4"></i>
                        <span>Dashboard</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a href="{{route('file.media')}}" class="nav-link {{request()->is('media')? 'active':''}}">
